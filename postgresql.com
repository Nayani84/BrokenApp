...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2024-10-03T15:33:21.438420" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/postgresql_cluster-v20-multi-cloud-postgresql-ha-clusters-free-open-source-2939/">postgresql_cluster v2.0: Multi-cloud PostgreSQL HA Clusters (free &amp; open-source)</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-09-24 by vitabaks</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v812-released-2937/">pgAdmin 4 v8.12 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-09-23 by pgAdmin Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgmustard-version-5-2938/">pgMustard version 5</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2024-09-23 by pgMustard</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6E3"> [PATCH IDEA] parallel pgbench -i</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Tomas Vondra</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-10-01</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6E2"> What&#x27;s so great about PostgreSQL v17?</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6E1"> Vasilis Ventirozos</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#x27;ads&#x27; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-09-30</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6D-"> Waiting for PostgreSQL 18 – Add temporal PRIMARY KEY and UNIQUE constra</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6DZ"> PostgreSQL Hacking Workshop - October 2024</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6DW"> Table Access Method: How Data Update is Handled in PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-09-27</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6DX"> pgsql_tweaks 0.10.6 released</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6DU"> Coming up in Postgres - PostgreSQL 17 and trends and innovations to watch</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Amit Kapila</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-09-27</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6DV"> pgsql_tweaks 0.10.5 released</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Stefanie Janine</li>
              <li><i class="far fa-clock"></i>&nbsp;2024-09-26</li>
            </ul>
